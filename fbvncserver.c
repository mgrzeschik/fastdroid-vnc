...
static void
init_fb_server(int argc, char **argv)
{
...
/*****************************************************************************/
void
injectKeyEvent(uint16_t code, uint16_t value)
{
...
void
injectTouchEvent(int down, int x, int y)
{
	struct input_event ev;
...
int
input_finder(int max_num, const char * *patterns, char *path, int path_size)
{
...
main(int argc, char **argv)
{
	...
	while (1) {
		...
		for (client_ptr = vncscr->clientHead; client_ptr;
